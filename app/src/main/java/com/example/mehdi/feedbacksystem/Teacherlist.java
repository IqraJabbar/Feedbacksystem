...
public class Teacherlist extends AppCompatActivity {
    ...
    int[] IMAGES = {R.drawable.teacher, R.drawable.teacher, R.drawable.teacher,R.drawable.teacher,R.drawable.teacher,R.drawable.teacher,R.drawable.teacher,R.drawable.teacher,R.drawable.teacher,R.drawable.teacher,};
